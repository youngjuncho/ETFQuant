...
class Inverse:
    ...
    def calculate(self, periods):
        rors = self._common.calculate_rate_of_returns(self._assets, periods)
        best_assets = {}
        for period in periods:
            ...
            best_assets[period] = [ticker for ticker, _ in sorted(period_rors.items(), key=lambda x: x[1], reverse=True)]
